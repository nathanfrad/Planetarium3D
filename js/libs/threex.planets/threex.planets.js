...
THREEx.Planets.createSun	= function(radius){
...
THREEx.Planets.createMercury	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createVenus	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createMoon	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createMars	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
...
THREEx.Planets.createJupiter	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
...
THREEx.Planets.createSaturn	= function(radius){
...
THREEx.Planets.createSaturnRing	= function( radius ){
	// create destination canvas
	var canvasResult	= document.createElement('canvas')
	...
	var geometry	= new THREEx.Planets._RingGeometry(radius, 0.75, 64); //0.55
	var material	= new THREE.MeshPhongMaterial({
		map		: new THREE.Texture(canvasResult),
...
THREEx.Planets.createUranus	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
...
THREEx.Planets.createUranusRing	= function(radius){
	// create destination canvas
	var canvasResult	= document.createElement('canvas')
	canvasResult.width	= 1024
...
THREEx.Planets.createNeptune	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
...
THREEx.Planets.createPluto	= function(radius){
	var geometry	= new THREE.SphereGeometry(radius, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
